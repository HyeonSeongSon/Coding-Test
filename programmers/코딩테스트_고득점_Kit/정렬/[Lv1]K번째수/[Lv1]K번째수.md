...
- `[1, 5, 2, 6, 3, 7, 4]`를 `2`번째부터 `5`번째까지 자른 후 정렬하면 `[2, 3, 5, 6]`입니다. 세 번째 숫자는 `5`입니다.
- `[1, 5, 2, 6, 3, 7, 4]`를 `4`번째부터 `4`번째까지 자른 후 정렬하면 `[6]`입니다. 첫 번째 숫자는 `6`입니다.
- `[1, 5, 2, 6, 3, 7, 4]`를 `1`번째부터 `7`번째까지 자른 후 정렬하면 `[1, 2, 3, 4, 5, 6, 7]`입니다. 세 번째 숫자는 `3`입니다.